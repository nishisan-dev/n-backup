...
# DEPRECATED since v3.0.0: gap_detection was removed.
# ChunkSACK per-chunk acknowledgment replaces this functionality.
# If present, a WARN will be emitted at startup and the section will be ignored.
# gap_detection:
#   enabled: true
#   timeout: 60s
...
| `gap_detection.*` | ❌ | **DEPRECATED since v3.0.0.** Ignored at runtime. |
...
9. **Gap Detection**: **Deprecated since v3.0.0.** The section is ignored at runtime.
